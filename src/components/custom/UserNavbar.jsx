...
export default function UserNavbar() {
  ...
  let [isLoggIn, setIsLoggIn] = useState(true);
  ...
  return (
    <nav className="bg-white dark:bg-zinc-900 shadow-md transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <Link href="/" className="flex-shrink-0">
              <span className="text-2xl font-black text-zinc-950 dark:text-zinc-100">
                Milte<span className="text-indigo-600">He</span>.
              </span>
            </Link>
